Pod::Spec.new do |spec|
  ...
  spec.pod_target_xcconfig = { 'HEADER_SEARCH_PATHS' => 'IoMT.SDK/Decoder/module.modulemap' }
  spec.xcconfig = { 'HEADER_SEARCH_PATHS' => 'IoMT.SDK/Decoder  IoMT.SDK/Decoder/module.modulemap' }
